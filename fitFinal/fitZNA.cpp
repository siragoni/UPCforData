...
void fitZNA(const char* AnalysisName){
  ...
  RooRealVar      sigma0Neutrons("sigma0Neutrons", "",    200.,    100.,  300. );
  RooRealVar      mean1Neutron  ("mean1Neutron",   "",   2500.,   2200., 2800. );
  RooRealVar      sigma1Neutron ("sigma1Neutron",  "",    500.,    400.,  550. );
  ...
  /* - The respective values for the global pdf's normalizations
     -
   */
  RooRealVar n0Neutrons    ("n0Neutrons",     "",    700,    600.,  750.);
  RooRealVar n1Neutron     ("n1Neutron",      "",    1600,    1000.,  2000.);
  RooRealVar n2Neutrons    ("n2Neutrons",     "",    600,    500.,  700.);
  RooRealVar n3Neutrons    ("n3Neutrons",     "",    220,     200.,  300.);
