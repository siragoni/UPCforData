...
void fitZNC(const char* AnalysisName){
  ...
  fZNCEnergyAgainstEntriesH->Rebin(100);
  ...
  RooRealVar      mean0Neutrons ("mean0Neutrons",  "",   0.1,     0.,     1. );
  RooRealVar      sigma0Neutrons("sigma0Neutrons", "",   500,   400.,   600. );
  RooRealVar      mean1Neutron  ("mean1Neutron",   "",  2500,  2400.,  2530. );
  RooRealVar      sigma1Neutron ("sigma1Neutron",  "",   600,   550.,   650. );
  ...
  /* - The respective values for the global pdf's normalizations
     -
   */
  RooRealVar n0Neutrons    ("n0Neutrons",     "",    750,    500.,  1000.);
  RooRealVar n1Neutron     ("n1Neutron",      "",   2000,   1900.,  2500.);
  RooRealVar n2Neutrons    ("n2Neutrons",     "",   1000,    800.,  1200.);
  RooRealVar n3Neutrons    ("n3Neutrons",     "",    800,    600.,  1000.);
