...
void ContourPlots(){
  ...
  TFile* fileHe = new TFile("pngResults/ContourFileHe.root");
  TFile* fileCs = new TFile("pngResults/ContourFileCs.root");
  ...
  axis1->SetLimits(0.5,2.5);                 // along X
  ...
  pmThetaVsLTPHe->SetPoint(0,1.208,-0.032);
  ...
  axis2->SetLimits(0.5,2.5);                 // along X
  ...
  pmThetaVsLTPCs->SetPoint(0,1.326,-0.038);
  ...
  texD->SetLineWidth(2);
  texD->Draw();
  TLine *line2 = new TLine(0.5,0.,2.5,0.);
  ...
  pmPhiVsLTPthreeHe->SetPoint(0,0.049,-0.032);
  ...
  pmPhiVsLTPthreeCs->SetPoint(0,0.052,-0.038);
  ...
  axis5->SetLimits(0.5,2.5);                   // along X
  ...
  pmThetaVsLPthreeHe->SetPoint(0,1.208,0.049);
  ...
  texC->SetLineWidth(2);
  texC->Draw();
  TLine *line5 = new TLine(0.5,0.,2.5,0.);
  ...
  axis6->SetLimits(0.5,2.5);                 // along X
  ...
  pmThetaVsLPthreeCs->SetPoint(0,1.326,0.052);
  ...
  texF->SetLineWidth(2);
  texF->Draw();
  TLine *line6 = new TLine(0.5,0.,2.5,0.);
  ...
  // leg->Draw();
  auto leg = new TLatex(1.8,-0.1,"3 #sigma");
  leg->SetTextSize(0.08);
  leg->SetLineWidth(2);
  leg->Draw();
  auto leg2 = new TLatex(1.8,-0.17,"#color[4]{2 #sigma}");
  leg2->SetTextSize(0.08);
  leg2->SetLineWidth(2);
  leg2->Draw();
  auto leg3 = new TLatex(1.8,-0.24,"#color[2]{1 #sigma}");
  ...
  c_super->SaveAs("pngResults/ContourPlotsPaper.png",  "RECREATE");
  c_super->SaveAs("pngResults/ContourPlotsPaper.pdf",  "RECREATE");
