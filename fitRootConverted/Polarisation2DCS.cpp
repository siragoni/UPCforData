...
void fitJPsiTemplate( const int selectionFlag, const int selectionFlag2 ){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject(Form("fInvariantMassDistributionForSignalExtractionCsFrameMyBinningH_%d_%d", selectionFlag, selectionFlag2));
