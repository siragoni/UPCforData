...
void fitJPsiTemplate( const int selectionFlag, const int selectionFlag2, Int_t SignalRangeModeFlag = 0){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject(Form("fInvariantMassDistributionForSignalExtractionHelicityFrameMyBinning0N0NH_%d_%d", selectionFlag, selectionFlag2));
  ...
  // gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d.png", selectionFlag, selectionFlag2), "recreate");
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d.png",        selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d_Range1.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d_Range2.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d_Range3.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d_Range4.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d_Range5.png", selectionFlag, selectionFlag2), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/2DHe_0N0N_%d_%d.png",        selectionFlag, selectionFlag2), "recreate"); }
...
void CreateCosThetaTh2(const char* AnalysisName, Int_t SignalRangeMode = 0){
  ...
  // TFile f("pngResults/Polarisation2DHE_0N0N.root", "recreate");
  ...
  if      ( SignalRangeMode == 0 ) {
    ...
    TFile f("pngResults/Polarisation2DHE_0N0N_1.root", "recreate");
    helicity2DafterSignalExtraction      ->Write();
    helicityOfGammaGamma                 ->Write();
    helicity2DafterSignalExtractionErrors->Write();
    helicityOfGammaGammaErrors           ->Write();
    ...
    TFile f("pngResults/Polarisation2DHE_0N0N_2.root", "recreate");
    helicity2DafterSignalExtraction      ->Write();
    helicityOfGammaGamma                 ->Write();
    helicity2DafterSignalExtractionErrors->Write();
    helicityOfGammaGammaErrors           ->Write();
    ...
    TFile f("pngResults/Polarisation2DHE_0N0N_3.root", "recreate");
    helicity2DafterSignalExtraction      ->Write();
    helicityOfGammaGamma                 ->Write();
    helicity2DafterSignalExtractionErrors->Write();
    helicityOfGammaGammaErrors           ->Write();
    ...
    TFile f("pngResults/Polarisation2DHE_0N0N_4.root", "recreate");
    helicity2DafterSignalExtraction      ->Write();
    helicityOfGammaGamma                 ->Write();
    helicity2DafterSignalExtractionErrors->Write();
    helicityOfGammaGammaErrors           ->Write();
    ...
    TFile f("pngResults/Polarisation2DHE_0N0N_5.root", "recreate");
    helicity2DafterSignalExtraction      ->Write();
    helicityOfGammaGamma                 ->Write();
    helicity2DafterSignalExtractionErrors->Write();
    helicityOfGammaGammaErrors           ->Write();
