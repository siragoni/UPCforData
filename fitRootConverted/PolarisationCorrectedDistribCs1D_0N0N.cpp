 ...
 * -
 */
void PolarisationCorrectedDistribCs1D_0N0N(){
  ...
  TDatime d;
  TFile* fileDataRawCosTheta = new TFile( Form("pngResults/%d-%2.2d-%2.2d/CosThetaCS_0N0N/CosThetaCSFrame_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  TFile* fileDataRawPhi      = new TFile( Form("pngResults/%d-%2.2d-%2.2d/PhiCS_0N0N/PhiCsFrame_0N0N.root",           d.GetYear(), d.GetMonth(), d.GetDay() ) );
  TFile* fileDataRawTildePhi = new TFile( Form("pngResults/%d-%2.2d-%2.2d/TildePhiCS_0N0N/TildePhiCsFrame_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  TFile f("pngResults/PolarisationCorrectedCs1D_0N0N.root", "recreate");
