...
void PolarisationCorrectedDistribHe1D( Int_t RangeSelectionMode = 0 ){
  ...
  TFile* fileList2 = new TFile("AnalysisResultsLHC18l7_19032021.root");
  TFile* fileList  = new TFile("AnalysisResultsLHC18l7_long_rapcut_partial_22042021.root");
  ...
  TH1F* fReconPhiH = (TH1F*)listings2->FindObject("fPhiCsFrameTwentyfiveBinsHv2");
  TH1F* fGenerPhiH = (TH1F*)listings2->FindObject("fMCPhiCsFrameTwentyfiveBinsHv2");
  // TH1F* fReconPhiH = (TH1F*)listings->FindObject("fPhiCsFrameTwentyfiveBinsHv2");
  // TH1F* fGenerPhiH = (TH1F*)listings->FindObject("fMCPhiCsFrameTwentyfiveBinsHv2");
  // TH1F* fReconPhiH = (TH1F*)listings->FindObject("fPhiCsFrameTwentyfiveBinsHv2_restrict");
  // TH1F* fGenerPhiH = (TH1F*)listings->FindObject("fMCPhiCsFrameTwentyfiveBinsHv2_restrict");
  fReconPhiH->Sumw2();
  fGenerPhiH->Sumw2();

  TH1F* fReconTildePhiH = (TH1F*)listings2->FindObject("fTildePhiCsFrameTwentyfiveBinsHv2");
  TH1F* fGenerTildePhiH = (TH1F*)listings2->FindObject("fMCTildePhiCsFrameTwentyfiveBinsHv2");
  // TH1F* fReconTildePhiH = (TH1F*)listings->FindObject("fTildePhiCsFrameTwentyfiveBinsHv2");
  // TH1F* fGenerTildePhiH = (TH1F*)listings->FindObject("fMCTildePhiCsFrameTwentyfiveBinsHv2");
  // TH1F* fReconTildePhiH = (TH1F*)listings->FindObject("fTildePhiCsFrameTwentyfiveBinsHv2_restrict");
  // TH1F* fGenerTildePhiH = (TH1F*)listings->FindObject("fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict");
  ...
  if (        RangeSelectionMode == 0 ) {
    ...
    fileDataRawPhi      = new TFile( Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCsFrameV2.root",             d.GetYear(), d.GetMonth(), d.GetDay() ) );
    fileDataRawTildePhi = new TFile( Form("pngResults/%d-%2.2d-%2.2d/TildePhiCSv2/TildePhiCsFrameV2.root",   d.GetYear(), d.GetMonth(), d.GetDay() ) );
  } else if ( RangeSelectionMode == 1 ) {
    fileDataRawCosTheta = new TFile( Form("pngResults/%d-%2.2d-%2.2d/CosTheta/CosThetaHeFrame_1.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  if        ( RangeSelectionMode == 0 ) {
    TDatime d;
    TFile f(Form("pngResults/%d-%2.2d-%2.2d/1DresultsV2/PolarisationCorrectedCs1Dv2_AxE.root",   d.GetYear(), d.GetMonth(), d.GetDay()), "recreate");
