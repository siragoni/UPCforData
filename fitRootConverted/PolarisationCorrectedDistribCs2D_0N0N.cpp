 ...
 * -
 */
void PolarisationCorrectedDistribCs2D_0N0N(){
  ...
  TDatime d;
  TFile* fileDataRaw = new TFile(Form("pngResults/%d-%2.2d-%2.2d/2DCS_0N0N/Polarisation2DCs_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  TFile f("pngResults/PolarisationCorrectedCs2D_0N0N.root", "recreate");
  acceptance->Write();
  RawH      ->Write();
  // AccErrors ->Write();
  f.Close();
