 ...
 * -
 */
void PolarisationCorrectedDistribHe1D_0N0N(){
  ...
  TDatime d;
  TFile* fileDataRawCosTheta = new TFile( Form("pngResults/%d-%2.2d-%2.2d/CosThetaHE_0N0N/CosThetaHeFrame_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  TFile* fileDataRawPhi      = new TFile( Form("pngResults/%d-%2.2d-%2.2d/PhiHE_0N0N/PhiHeFrame_0N0N.root",           d.GetYear(), d.GetMonth(), d.GetDay() ) );
  TFile* fileDataRawTildePhi = new TFile( Form("pngResults/%d-%2.2d-%2.2d/TildePhiHE_0N0N/TildePhiHeFrame_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  TFile f("pngResults/PolarisationCorrectedHe1D_0N0N.root", "recreate");
