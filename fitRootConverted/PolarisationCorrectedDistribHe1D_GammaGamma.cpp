...
void PolarisationCorrectedDistribHe1D( Int_t RangeSelectionMode = 0 ){
  ...
  TFile* fileList = new TFile("MCtrainResults/2019-09-17/kTwoGammaToMuMedium/AnalysisResults.root");
  ...
  if        ( RangeSelectionMode == 0 ) {
    TFile f(Form("pngResults/%d-%2.2d-%2.2d/1Dresults/PolarisationCorrectedHe1D_GammaGamma.root",   d.GetYear(), d.GetMonth(), d.GetDay() ) , "recreate");
