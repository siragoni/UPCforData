...
void PolarisationCorrectedDistribHe1D( Int_t RangeSelectionMode = 0 ){
  ...
  // TH1F* fReconPhiH = (TH1F*)listings2->FindObject("fPhiHelicityFrameTwentyfiveBinsHv2");
  // TH1F* fGenerPhiH = (TH1F*)listings2->FindObject("fMCPhiHelicityFrameTwentyfiveBinsHv2");
  // TH1F* fReconPhiH = (TH1F*)listings2->FindObject("fPhiHelicityFrameTwentyfiveBinsHv2_restrict");
  // TH1F* fGenerPhiH = (TH1F*)listings2->FindObject("fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict");
  ...
  // TH1F* fReconTildePhiH = (TH1F*)listings2->FindObject("fTildePhiHelicityFrameTwentyfiveBinsHv2");
  // TH1F* fGenerTildePhiH = (TH1F*)listings2->FindObject("fMCTildePhiHelicityFrameTwentyfiveBinsHv2");
  // TH1F* fReconTildePhiH = (TH1F*)listings2->FindObject("fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict");
  // TH1F* fGenerTildePhiH = (TH1F*)listings2->FindObject("fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict");
  ...
  if        ( RangeSelectionMode == 0 ) {
    TDatime d;
    TFile f(Form("pngResults/%d-%2.2d-%2.2d/1DresultsV2/PolarisationCorrectedHe1Dv2_AxE.root",   d.GetYear(), d.GetMonth(), d.GetDay()), "recreate");
