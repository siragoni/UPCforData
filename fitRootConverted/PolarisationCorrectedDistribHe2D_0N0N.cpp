 ...
 * -
 */
void PolarisationCorrectedDistribHe2D_0N0N(){
  ...
  TDatime d;
  TFile* fileDataRaw = new TFile(Form("pngResults/%d-%2.2d-%2.2d/2DHE_0N0N/Polarisation2DHE_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  TFile f("pngResults/PolarisationCorrectedHe2D_0N0N.root", "recreate");
  acceptance->Write();
  RawH      ->Write();
  // AccErrors ->Write();
  f.Close();
