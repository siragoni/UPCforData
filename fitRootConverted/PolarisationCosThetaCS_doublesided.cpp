...
void trialfunc(Int_t select = 15){
  ...
  fCohJpsiToMu        = (TH1F*)listingsMC[0]->FindObject(Form("fInvariantMassDistributionOnlyCosThetaCsFrameTwentyfiveBinsH_%d", select));
  fCohJpsiToMu        -> Sumw2();
...
void fitJPsiTemplate(const int selectionFlag, Int_t SignalRangeModeFlag = 0){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyCosThetaCsFrameTwentyfiveBinsH_%d", selectionFlag) );
  ...
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d.png",        selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d_Range1.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d_Range2.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d_Range3.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d_Range4.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d_Range5.png", selectionFlag), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/CosThetaCs_DSCB_%d.png",        selectionFlag), "recreate"); }
...
void CreateCosThetaTh1(const char* AnalysisName, Int_t SignalRangeMode = 0){
  ...
  if      ( SignalRangeMode == 0 ) {
    TFile f("pngResults/CosThetaCsFrame_DSCB.root",   "recreate");
    ...
    TFile f("pngResults/CosThetaCsFrame_DSCB_1.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_DSCB_2.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_DSCB_3.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_DSCB_4.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_DSCB_5.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
