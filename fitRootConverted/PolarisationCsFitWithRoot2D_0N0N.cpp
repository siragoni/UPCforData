...
/* - Fit function for the helicity case. It is basically a parabolic fit...
   -
 */
void PolarisationCsFitWithRoot2D_0N0N(){

  TDatime d;
  TFile* data = new TFile(Form("pngResults/%d-%2.2d-%2.2d/2DCS_0N0N/PolarisationCorrectedCs2D_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  gPad->SaveAs("pngResults/PolFitWithRootCs2D_0N0N.png",         "RECREATE");
