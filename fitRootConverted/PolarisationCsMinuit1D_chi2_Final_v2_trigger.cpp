...
void PolarisationHeMinuit1D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  if        ( SignalRangeSelectionMode == 0 ) {
    ...
    file1D = new TFile("pngResults/PolTrigger1/1Dresults/PolarisationCorrectedCs1D.root");
  } else if ( SignalRangeSelectionMode == 1 ) {
    file1D = new TFile("pngResults/PolTrigger2/1Dresults/PolarisationCorrectedCs1D.root");
  } else if ( SignalRangeSelectionMode == 2 ) {
    file1D = new TFile("pngResults/PolTrigger3/1Dresults/PolarisationCorrectedCs1D.root");
  } else if ( SignalRangeSelectionMode == 3 ) {
    file1D = new TFile("pngResults/PolTrigger4/1Dresults/PolarisationCorrectedCs1D.root");
  } else if ( SignalRangeSelectionMode == 4 ) {
    file1D = new TFile("pngResults/PolTrigger5/1Dresults/PolarisationCorrectedCs1D.root");
  } else if ( SignalRangeSelectionMode == 5 ) {
    file1D = new TFile("pngResults/PolTrigger6/1Dresults/PolarisationCorrectedCs1D.root");
  } else if ( SignalRangeSelectionMode == 6 ) {
    file1D = new TFile("pngResults/PolTrigger7/1Dresults/PolarisationCorrectedCs1D.root");
  } else {
  ...
  TFile SavingFile( Form("pngResults/PolTrigger%d/1Dresults/Parameters_SigEx_0_FitRange_0_CS.root",  SignalRangeSelectionMode+1), "recreate" );
