...
void PolarisationCsMinuit1D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  TDatime d;
  TFile* file1D = file1D = new TFile("pngResults/PolarisationCorrectedCs1D_closuretest.root" );


  TH1F* CorrectedCosTheta = 0x0;
  TH1F* CorrectedPhi      = 0x0;
  TH1F* CorrectedTildePhi = 0x0;
  if (      SignalRangeSelectionMode == 0 ){ // Full T MC, Full T AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaFullT0");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiFullT0");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiFullT0");
  } else if ( SignalRangeSelectionMode == 1 ){// Full T MC, Short T AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaFullT1");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiFullT1");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiFullT1");
  } else if ( SignalRangeSelectionMode == 2 ){// Full T MC, Short L AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaFullT2");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiFullT2");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiFullT2");
  } else if ( SignalRangeSelectionMode == 3 ){ // Short T MC, Full T AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaShortT0");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiShortT0");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiShortT0");
  } else if ( SignalRangeSelectionMode == 4 ){// Short T  MC, Short T AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaShortT1");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiShortT1");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiShortT1");
  } else if ( SignalRangeSelectionMode == 5 ){// Short T MC, Short L AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaShortT2");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiShortT2");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiShortT2");
  } else if ( SignalRangeSelectionMode == 6 ){ // Short L MC, Full T AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaShortL0");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiShortL0");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiShortL0");
  } else if ( SignalRangeSelectionMode == 7 ){// Short L  MC, Short T AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaShortL1");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiShortL1");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiShortL1");
  } else if ( SignalRangeSelectionMode == 8 ){// Short L MC, Short L AxE
    CorrectedCosTheta = (TH1F*) file1D->Get("DataThetaShortL2");
    CorrectedPhi      = (TH1F*) file1D->Get("DataPhiShortL2");
    CorrectedTildePhi = (TH1F*) file1D->Get("DataTildePhiShortL2");
  }
  ...
  gMinuit->DefineParameter(0, "LambdaTheta", 1., 0.1, -2, 2);
  gMinuit->DefineParameter(1, "NormalTheta", 4000000, 100,  2000, 80000000);
  gMinuit->DefineParameter(2, "NormalisPhi",      1200000, 10,  2000, 40000000);
  gMinuit->DefineParameter(3, "LambdaPhi",           0, 0.1,    -2, 2   );
  gMinuit->DefineParameter(4, "NormalisTildePhi", 1200000, 10,  2000, 40000000);
  gMinuit->DefineParameter(5, "LambdaThetaPhi",      0, 0.1,    -2, 2   );
  ...
  if (      SignalRangeSelectionMode == 0 ) latex->DrawLatex(0.55,0.78,"Full  T / Full  T");
  else if ( SignalRangeSelectionMode == 1 ) latex->DrawLatex(0.55,0.78,"Full  T / Short T");
  else if ( SignalRangeSelectionMode == 2 ) latex->DrawLatex(0.55,0.78,"Full  T / Short L");
  else if ( SignalRangeSelectionMode == 3 ) latex->DrawLatex(0.55,0.78,"Short T / Full  T");
  else if ( SignalRangeSelectionMode == 4 ) latex->DrawLatex(0.55,0.78,"Short T / Short T");
  else if ( SignalRangeSelectionMode == 5 ) latex->DrawLatex(0.55,0.78,"Short T / Short L");
  else if ( SignalRangeSelectionMode == 6 ) latex->DrawLatex(0.55,0.78,"Short L / Full  T");
  else if ( SignalRangeSelectionMode == 7 ) latex->DrawLatex(0.55,0.78,"Short L / Short T");
  else if ( SignalRangeSelectionMode == 8 ) latex->DrawLatex(0.55,0.78,"Short L / Short L");
  ...
  if (      SignalRangeSelectionMode == 0 ) latex2->DrawLatex(0.55,0.78,"Full  T / Full  T");
  else if ( SignalRangeSelectionMode == 1 ) latex2->DrawLatex(0.55,0.78,"Full  T / Short T");
  else if ( SignalRangeSelectionMode == 2 ) latex2->DrawLatex(0.55,0.78,"Full  T / Short L");
  else if ( SignalRangeSelectionMode == 3 ) latex2->DrawLatex(0.55,0.78,"Short T / Full  T");
  else if ( SignalRangeSelectionMode == 4 ) latex2->DrawLatex(0.55,0.78,"Short T / Short T");
  else if ( SignalRangeSelectionMode == 5 ) latex2->DrawLatex(0.55,0.78,"Short T / Short L");
  else if ( SignalRangeSelectionMode == 6 ) latex2->DrawLatex(0.55,0.78,"Short L / Full  T");
  else if ( SignalRangeSelectionMode == 7 ) latex2->DrawLatex(0.55,0.78,"Short L / Short T");
  else if ( SignalRangeSelectionMode == 8 ) latex2->DrawLatex(0.55,0.78,"Short L / Short L");
  ...
  if (      SignalRangeSelectionMode == 0 ) latex3->DrawLatex(0.55,0.78,"Full  T / Full  T");
  else if ( SignalRangeSelectionMode == 1 ) latex3->DrawLatex(0.55,0.78,"Full  T / Short T");
  else if ( SignalRangeSelectionMode == 2 ) latex3->DrawLatex(0.55,0.78,"Full  T / Short L");
  else if ( SignalRangeSelectionMode == 3 ) latex3->DrawLatex(0.55,0.78,"Short T / Full  T");
  else if ( SignalRangeSelectionMode == 4 ) latex3->DrawLatex(0.55,0.78,"Short T / Short T");
  else if ( SignalRangeSelectionMode == 5 ) latex3->DrawLatex(0.55,0.78,"Short T / Short L");
  else if ( SignalRangeSelectionMode == 6 ) latex3->DrawLatex(0.55,0.78,"Short L / Full  T");
  else if ( SignalRangeSelectionMode == 7 ) latex3->DrawLatex(0.55,0.78,"Short L / Short T");
  else if ( SignalRangeSelectionMode == 8 ) latex3->DrawLatex(0.55,0.78,"Short L / Short L");
