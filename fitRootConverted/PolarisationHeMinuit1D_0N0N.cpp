...
/* - Fit function for the helicity case. It is basically a parabolic fit...
   -
 */
void PolarisationHeMinuit1D_0N0N(){

  TDatime d;
  TFile* file1D = new TFile(Form("pngResults/%d-%2.2d-%2.2d/1Dresults_0N0N/PolarisationCorrectedHe1D_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  Model->SetNpx(500);
  Model->Draw("same");
  gPad->SaveAs("pngResults/CosThetaHeMinuit_0N0N.png", "recreate");
  ...
  latex2->DrawLatex(0.55,0.84,"UPC, Run 2, 0N0N, HE");
  ...
  Model2->SetNpx(500);
  Model2->Draw("same");
  gPad->SaveAs("pngResults/PhiHeMinuit_0N0N.png", "recreate");
  ...
  latex3->DrawLatex(0.55,0.84,"UPC, Run 2, 0N0N, HE");
  ...
  Model3->SetNpx(500);
  Model3->Draw("same");
  gPad->SaveAs("pngResults/TildePhiHeMinuit_0N0N.png", "recreate");
