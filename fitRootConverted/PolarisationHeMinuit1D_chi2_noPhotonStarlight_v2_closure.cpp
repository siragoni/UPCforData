...
void PolarisationHeMinuit1D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  if        ( SignalRangeSelectionMode == 0 ) {
    file1D = new TFile(Form("pngResults/%d-%2.2d-%2.2d/Closure/PolarisationCorrectedHe1Dv2_RecTAxET.root",   d.GetYear(), d.GetMonth(), d.GetDay() ) );
  } else if ( SignalRangeSelectionMode == 1 ) {
    file1D = new TFile(Form("pngResults/%d-%2.2d-%2.2d/Closure/PolarisationCorrectedHe1Dv2_RecTAxEL.root",   d.GetYear(), d.GetMonth(), d.GetDay() ) );
  }
  ...
  gMinuit->DefineParameter(0, "LambdaTheta", 1., 0.01, 0., 2);
  // gMinuit->DefineParameter(0, "LambdaTheta", 1., 0.01, -2, 2);
  gMinuit->DefineParameter(1, "NormalTheta", 2.60e+04, 100,  2.2e+04, 3.2e+07);
  ...
  gMinuit->DefineParameter(4, "NormalisTildePhi", 400000, 100,  200000, 600000);
