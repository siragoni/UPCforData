...
void PolarisationHeMinuit1D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  if        ( SignalRangeSelectionMode == 0 ) {
    file1D = new TFile(Form("pngResults/%d-%2.2d-%2.2d/1Dresults/PolarisationCorrectedHe1D_purity90_bis.root",   d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  gMinuit->DefineParameter(1, "NormalTheta", 3.00e+04, 100,  2.5e+04, 3.5e+04);
