...
void PolarisationHeMinuit1D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  // fGenerCosThetaH->Scale( (CorrectedCosTheta->GetBinContent(CorrectedCosTheta->GetMinimumBin())) / (fGenerCosThetaH->GetBinContent(fGenerCosThetaH->GetMinimumBin())) );
  // fGenerPhiH     ->Scale( (CorrectedPhi     ->GetBinContent(CorrectedPhi     ->GetMinimumBin())) / (fGenerPhiH     ->GetBinContent(fGenerPhiH     ->GetMinimumBin())) );
  // fGenerTildePhiH->Scale( (CorrectedTildePhi->GetBinContent(CorrectedTildePhi->GetMinimumBin())) / (fGenerTildePhiH->GetBinContent(fGenerTildePhiH->GetMinimumBin())) );
  fGenerCosThetaH->Scale( (CorrectedCosTheta->GetBinContent(14)) / (fGenerCosThetaH->GetBinContent(14)) );
  fGenerPhiH     ->Scale( (CorrectedPhi     ->GetBinContent(14)) / (fGenerPhiH     ->GetBinContent(14)) );
  fGenerTildePhiH->Scale( (CorrectedTildePhi->GetBinContent(13)) / (fGenerTildePhiH->GetBinContent(13)) );
  ...
  Model->SetNpx(500);
  Model->Draw("same");
  fGenerCosThetaH->SetLineWidth(3);
  fGenerCosThetaH->SetLineColor(kGreen);
  fGenerCosThetaH->Draw("same");
  ...
  Model2->SetNpx(500);
  Model2->Draw("same");
  fGenerPhiH->SetLineWidth(3);
  fGenerPhiH->SetLineColor(kGreen);
  fGenerPhiH->Draw("same");
  ...
  Model3->SetNpx(500);
  Model3->Draw("same");
  fGenerTildePhiH->SetLineWidth(3);
  fGenerTildePhiH->SetLineColor(kGreen);
  fGenerTildePhiH->Draw("same");
