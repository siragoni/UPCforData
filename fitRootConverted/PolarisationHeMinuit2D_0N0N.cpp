...
/* - Fit function for the helicity case. It is basically a parabolic fit...
   -
 */
void PolarisationHeMinuit2D_0N0N(){

  TDatime d;
  TFile* file2D = new TFile(Form("pngResults/%d-%2.2d-%2.2d/2DHE_0N0N/PolarisationCorrectedHe2D_0N0N.root", d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  // Model->SetNpx(500);
  Model->Draw("same");
  gPad->SaveAs("pngResults/He2DMinuit_0N0N.png", "recreate");
  cout << "OK4" << endl << flush;
