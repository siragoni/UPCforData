...
void PolarisationHeMinuit1D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  if        ( SignalRangeSelectionMode == 0 ) {
    file1D = new TFile(Form("pngResults/%d-%2.2d-%2.2d/1DresultsV2/PolarisationCorrectedHe1Dv2.root",   d.GetYear(), d.GetMonth(), d.GetDay() ) );
  ...
  //                                    )
  //                                   );
  Model->SetParameter( 0, 0.956 );
  Model->SetParameter( 1, 3.*8.28735e+03 );
  Model->SetNpx(500);
  Model->SetLineColor(kRed);
  Model->Draw("PLC PMC same");
  Model->Draw(" same");
  ModelCS->SetParameter( 0, 0.965 );
  ModelCS->SetParameter( 1, (3.*8.28243e+03) * 1.6 );
  ModelCS->SetNpx(500);
  ...
  TF1* Model2CS = new TF1("Model2CS", "[1]*(1+2*[2]*cos(2*x)/(3+[0]))", 0. ,2.*TMath::Pi() );
  new TCanvas;
  // gPad->SetMargin(0.13,0.01,0.12,0.01);
  gPad->SetMargin(0.13,0.01,0.12,0.01);
  gPad->SetLeftMargin(0.15);
  ...
  //                                    )
  //                                   );
  Model2->SetParameter( 0, 0.956 );
  Model2->SetParameter( 2, 0.040 );
  Model2->SetParameter( 1, 8.28735e+03 );
  Model2->SetNpx(500);
  Model2->SetLineColor(kRed);
  Model2->Draw("PLC PMC same");
  Model2->Draw(" same");
  Model2CS->SetParameter( 0, 0.965 );
  Model2CS->SetParameter( 2, 0.038 );
  Model2CS->SetParameter( 1, (8.28243e+03) * 1.6 );
  Model2CS->SetNpx(500);
  ...
  TF1* Model3 = new TF1("Model3", "[1]*(1+TMath::Sqrt(2)*[2]*cos(2*x)/(3+[0]))", 0. ,2.*TMath::Pi() );
  TF1* Model3CS = new TF1("Model3CS", "[1]*(1+TMath::Sqrt(2)*[2]*cos(2*x)/(3+[0]))", 0. ,2.*TMath::Pi() );
  new TCanvas;
  // gPad->SetMargin(0.13,0.01,0.12,0.01);
  gPad->SetMargin(0.13,0.01,0.12,0.01);
  gPad->SetLeftMargin(0.15);
  ...
  //                                    )
  //                                   );
  Model3->SetParameter( 0, 0.956      );
  Model3->SetParameter( 2, -0.033   );
  Model3->SetParameter( 1, 8.28735e+03 );
  Model3->SetNpx(500);
  // Model3->Draw("same");
  Model3->SetLineColor(kRed);
  Model3->Draw("PLC PMC same");
  Model3->Draw(" same");
  Model3CS->SetParameter( 0, 0.965 );
  Model3CS->SetParameter( 2, -0.028 );
  Model3CS->SetParameter( 1, (8.28243e+03) * 1.6 );
  Model3CS->SetNpx(500);
