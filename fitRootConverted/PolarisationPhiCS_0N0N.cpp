...
void fitJPsiTemplate(const int selectionFlag, Int_t SignalRangeModeFlag = 0){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyPhiCsFrameTwentyfiveBins0N0NH_%d", selectionFlag) );
  ...
  // gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d.png", selectionFlag), "recreate");
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d.png",        selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d_Range1.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d_Range2.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d_Range3.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d_Range4.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d_Range5.png", selectionFlag), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/PhiCs_0N0N_%d.png",        selectionFlag), "recreate"); }
...
void CreateCosThetaTh1(const char* AnalysisName, Int_t SignalRangeMode = 0){
  ...
  // TFile f("pngResults/PhiCsFrame_0N0N.root", "recreate");
  if      ( SignalRangeMode == 0 ) {
    ...
    TFile f("pngResults/PhiCsFrame_0N0N_1.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_0N0N_2.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_0N0N_3.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_0N0N_4.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_0N0N_5.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
