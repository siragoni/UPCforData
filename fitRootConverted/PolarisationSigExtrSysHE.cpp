...
void PolarisationSigExtrSystematicsHE(){
  ...
  graph1->Draw("AP");
  gPad->SaveAs("pngResults/CosThetaSysExtractHE.png", "recreate");
  // canvas1->Update();
  ...
  // Draw the graph on the canvas.
  graph2->Draw("AP");
  gPad->SaveAs("pngResults/PhiSysExtractHE.png", "recreate");
  // canvas1->Update();
  ...
  // Draw the graph on the canvas.
  graph3->Draw("AP");
  gPad->SaveAs("pngResults/TildeSysExtractHE.png", "recreate");
  // canvas1->Update();
