...
void fitJPsiTemplateMC(const int selectionFlag = 0){
  ...
  // }
  fCohJpsiToMu        = (TH1F*)listingsMC[0]->FindObject(Form("fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBinsH_%d", selectionFlag));
...
void fitJPsiTemplate(const int selectionFlag, Int_t SignalRangeModeFlag = 0){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBins0N0NH_%d", selectionFlag) );
  ...
  // gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d.png", selectionFlag), "recreate");
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d.png",        selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d_Range1.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d_Range2.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d_Range3.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d_Range4.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d_Range5.png", selectionFlag), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/TildePhiHe_0N0N_%d.png",        selectionFlag), "recreate"); }
...
void CreateCosThetaTh1(const char* AnalysisName, Int_t SignalRangeMode = 0){
  ...
  // TFile f("pngResults/TildePhiHeFrame_0N0N.root", "recreate");
  if      ( SignalRangeMode == 0 ) {
    ...
    TFile f("pngResults/TildePhiHeFrame_0N0N_1.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_0N0N_2.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_0N0N_3.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_0N0N_4.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_0N0N_5.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
