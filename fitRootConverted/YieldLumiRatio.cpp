...
void YieldLumiRatio(){
  ...
  Double_t LUMImine        = 740.71;
  Double_t LUMIevgeny      = 754;
  Double_t NumOfJPsiMine[7]   = { 21835, 929, 3183, 5727, 6594, 4241, 1140 };
  ...
  Double_t y1Error[7] = { 0,0,0,0,0,0,0};
  ...
  CoherentEvgeny  = new TGraphErrors(7, x1, YieldLumiRatioEvgeny, x1Error, y1Error);
  CoherentRatio   = new TGraphErrors(7, x1, FinalRatio,           x1Error, y1Error);
