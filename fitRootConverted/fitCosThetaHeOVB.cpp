...
//  TF1* ParabolicFit = new TF1("ParabolicFit","[0]*(1-[1]+(3*[1]-1)*x*x)",-1., 1.);
  ...
  fCorrectedShape->GetYaxis()->SetRangeUser(5, /*fCorrectedShape->GetMaximum()*10.*/2500);
  ...
  gPad->SaveAs("pngResults/CosThetaHeOvb.png", "RECREATE");

  new TCanvas;
  acceptance->Draw("ep");
  gPad->SaveAs("pngResults/CosThetaHeOvbACCxEFF.png", "RECREATE");
