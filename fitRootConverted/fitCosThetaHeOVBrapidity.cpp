                       ...
                       int iRapidityBin             )
{
   ...
   */
  TH1F *fAngularDistribOfPositiveMuonRestFrameJPsiH = (TH1F*)listingsData->FindObject( Form("fCosThetaHelicityFrameJPsiRapidityBinsH_%d", iRapidityBin) );
  ...
  TH1F *fMCAngularDistribOfPositiveMuonRestFrameJPsiH = (TH1F*)listingsMC->FindObject( Form("fCosThetaHelicityFrameJPsiRapidityBinsH_%d", iRapidityBin) );
  ...
  TH1F *fMCthetaDistribOfPositiveMuonRestFrameJPsiGeneratedTruthH = (TH1F*)listingsMC->FindObject( Form("fMCCosThetaHelicityFrameJPsiRapidityBinsH_%d", iRapidityBin) );
...
//  TF1* ParabolicFit = new TF1("ParabolicFit","[0]*(1-[1]+(3*[1]-1)*x*x)",-1., 1.);
  ...
  gPad->SaveAs(Form("pngResults/CosThetaHeOvb_%d.png", iRapidityBin), "RECREATE");

  new TCanvas;
  acceptance->Draw("ep");
  gPad->SaveAs(Form("pngResults/CosThetaHeOvbACCxEFF_%d.png", iRapidityBin), "RECREATE");
