...
void fitHelicityCorrected1D(){
   ...
   */
  TH1F* fReconCosThetaH = (TH1F*)listings->FindObject("fCosThetaHelicityFrameMyBinningSmallH");
  TH1F* fGenerCosThetaH = (TH1F*)listings->FindObject("fMCCosThetaHelicityFrameMyBinningSmallH");
  ...
  TFile* fileDataRawCosTheta = new TFile("pngResults/TH1functionalCosThetaMySmallBinningEX.root");
