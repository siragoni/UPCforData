...
void fitHelicityCorrected1D(){
  ...
  TFile* fileList = new TFile("AnalysisResultsMC09072019.root");
   ...
   */
  TH1F* fReconCosThetaH = (TH1F*)listings->FindObject("fCosThetaHelicityFrameMySeventeenBinningH");
  TH1F* fGenerCosThetaH = (TH1F*)listings->FindObject("fMCCosThetaHelicityFrameMySeventeenBinningH");
