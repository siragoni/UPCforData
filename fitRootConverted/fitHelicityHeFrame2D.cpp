...
void fitHelicityShape(const char* AnalysisName, const char* MonteCarloName){
   ...
   */
  new TCanvas;
  TH2F *fAngularDistribOfPositiveMuonRestFrameJPsiH = (TH2F*)listingsData->FindObject("fInvariantMassDistributionBinsOfCosThetaAndPhiHelicityFrameH");
  fAngularDistribOfPositiveMuonRestFrameJPsiH->Sumw2();
  // fAngularDistribOfPositiveMuonRestFrameJPsiH->Rebin2D(2,2); // rebin usually used
  ...
  new TCanvas;
  TH2F *fMCAngularDistribOfPositiveMuonRestFrameJPsiH = (TH2F*)listingsMC->FindObject("fInvariantMassDistributionBinsOfCosThetaAndPhiHelicityFrameH");
  fMCAngularDistribOfPositiveMuonRestFrameJPsiH->Sumw2();
  // fMCAngularDistribOfPositiveMuonRestFrameJPsiH->Rebin2D(2,2);
  fMCAngularDistribOfPositiveMuonRestFrameJPsiH->Rebin2D(4,4);
  ...
  new TCanvas;
  TH2F *fMCthetaDistribOfPositiveMuonRestFrameJPsiGeneratedTruthH = (TH2F*)listingsMC->FindObject("fMCInvariantMassDistributionBinsOfCosThetaAndPhiHelicityFrameH");
  ...
  fMCthetaDistribOfPositiveMuonRestFrameJPsiGeneratedTruthH->Rebin2D(4,4);
  ...
  */
  ...
  ParabolicFit->SetParameter(3, 300);
  ...
  fCorrectedShape->GetYaxis()->SetRangeUser(-3, 3);
  ...
  gPad->SaveAs("pngResults/fit2D.png",         "RECREATE");

  new TCanvas;
  acceptance->Draw("ep");
  gPad->SaveAs("pngResults/fit2D_ACCxEFF.png", "RECREATE");
