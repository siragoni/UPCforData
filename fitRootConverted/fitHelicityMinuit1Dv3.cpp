...
void fitHelicitySimultaneously1d(){
  ...
  //
  // ROOT::Math::Functor f(&FcnForMinimisation,4);
  // double step[4]     = {  0.01, 100, 100,    0.1};
  // double variable[4] = { -1.,   25500, 4000, 0. };
  //
  // minimum->SetFunction(f);
  // // Set the free variables to be minimized !
  // minimum->SetVariable(0,"LambdaTheta",variable[0], step[0]);
  // minimum->SetVariable(1,"NormalTheta",variable[1], step[1]);
  // minimum->SetVariable(2,"NormalisPhi",variable[2], step[2]);
  // minimum->SetVariable(3,"LambdaPhi",  variable[3], step[3]);
  // minimum->SetVariableLimits(0,-2,2);
  // minimum->SetVariableLimits(1,20000,3000);
  // minimum->SetVariableLimits(2, 2000,8000);
  // minimum->SetVariableLimits(3,-2,2);
  // // do the minimization
  // minimum->Minimize();
  // const double *xs = minimum->X();
  // std::cout << "Minimum: f(" << xs[0] << "," << xs[1] << "," << xs[2] << "," << xs[3] << "): " << endl;
  ...
  gMinuit->mnparm(0, "LambdaTheta",    1., 0.1,     -2,     2, ierflg ); // LambdaTheta
