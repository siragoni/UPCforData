...
void fitJPsiTemplate(const char* AnalysisName, const int selectionFlag){
  ...
  if      ( selectionFlag == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_0");
  else if ( selectionFlag == 1 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_1");
  else if ( selectionFlag == 2 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_2");
  else if ( selectionFlag == 3 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_3");
  else if ( selectionFlag == 4 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_4");
  else if ( selectionFlag == 5 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_5");
  else if ( selectionFlag == 6 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_6");
  else if ( selectionFlag == 7 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_7");
  else if ( selectionFlag == 8 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_8");
  else if ( selectionFlag == 9 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionInBinsOfCosThetaHelicityFrameH_9");
  ...
  if      ( selectionFlag == 0 ) gPad->SaveAs("pngResults/JPsiCosThetaBin0.png",   "RECREATE");
  else if ( selectionFlag == 1 ) gPad->SaveAs("pngResults/JPsiCosThetaBin1.png",   "RECREATE");
  else if ( selectionFlag == 2 ) gPad->SaveAs("pngResults/JPsiCosThetaBin2.png",   "RECREATE");
  else if ( selectionFlag == 3 ) gPad->SaveAs("pngResults/JPsiCosThetaBin3.png",   "RECREATE");
  else if ( selectionFlag == 4 ) gPad->SaveAs("pngResults/JPsiCosThetaBin4.png",   "RECREATE");
  else if ( selectionFlag == 5 ) gPad->SaveAs("pngResults/JPsiCosThetaBin5.png",   "RECREATE");
  else if ( selectionFlag == 6 ) gPad->SaveAs("pngResults/JPsiCosThetaBin6.png",   "RECREATE");
  else if ( selectionFlag == 7 ) gPad->SaveAs("pngResults/JPsiCosThetaBin7.png",   "RECREATE");
  else if ( selectionFlag == 8 ) gPad->SaveAs("pngResults/JPsiCosThetaBin8.png",   "RECREATE");
  else if ( selectionFlag == 9 ) gPad->SaveAs("pngResults/JPsiCosThetaBin9.png",   "RECREATE");
  ...
  if      ( selectionFlag == 0 ) gPad->SaveAs("pngResults/JPsiCosThetaBin0leg.png",   "RECREATE");
  else if ( selectionFlag == 1 ) gPad->SaveAs("pngResults/JPsiCosThetaBin1leg.png",   "RECREATE");
  else if ( selectionFlag == 2 ) gPad->SaveAs("pngResults/JPsiCosThetaBin2leg.png",   "RECREATE");
  else if ( selectionFlag == 3 ) gPad->SaveAs("pngResults/JPsiCosThetaBin3leg.png",   "RECREATE");
  else if ( selectionFlag == 4 ) gPad->SaveAs("pngResults/JPsiCosThetaBin4leg.png",   "RECREATE");
  else if ( selectionFlag == 5 ) gPad->SaveAs("pngResults/JPsiCosThetaBin5leg.png",   "RECREATE");
  else if ( selectionFlag == 6 ) gPad->SaveAs("pngResults/JPsiCosThetaBin6leg.png",   "RECREATE");
  else if ( selectionFlag == 7 ) gPad->SaveAs("pngResults/JPsiCosThetaBin7leg.png",   "RECREATE");
  else if ( selectionFlag == 8 ) gPad->SaveAs("pngResults/JPsiCosThetaBin8leg.png",   "RECREATE");
  else if ( selectionFlag == 9 ) gPad->SaveAs("pngResults/JPsiCosThetaBin9leg.png",   "RECREATE");
  else                           gPad->SaveAs("pngResults/ops.png",                   "RECREATE");
