...
void fitJPsiTemplate(const char* AnalysisName, const int selectionFlag){
  ...
  if      ( selectionFlag == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentRapidityBinsH_0");
  else if ( selectionFlag == 1 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentRapidityBinsH_1");
  else if ( selectionFlag == 2 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentRapidityBinsH_2");
  else if ( selectionFlag == 3 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentRapidityBinsH_3");
  else if ( selectionFlag == 4 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentRapidityBinsH_4");
  else if ( selectionFlag == 5 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentRapidityBinsH_5");
  else                           fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionCoherentH");
  ...
  if      ( selectionFlag == 0 ) gPad->SaveAs("pngResults/CoherentRapidity_0.png", "RECREATE");
  else if ( selectionFlag == 1 ) gPad->SaveAs("pngResults/CoherentRapidity_1.png", "RECREATE");
  else if ( selectionFlag == 2 ) gPad->SaveAs("pngResults/CoherentRapidity_2.png", "RECREATE");
  else if ( selectionFlag == 3 ) gPad->SaveAs("pngResults/CoherentRapidity_3.png", "RECREATE");
  else if ( selectionFlag == 4 ) gPad->SaveAs("pngResults/CoherentRapidity_4.png", "RECREATE");
  else if ( selectionFlag == 5 ) gPad->SaveAs("pngResults/CoherentRapidity_5.png", "RECREATE");
