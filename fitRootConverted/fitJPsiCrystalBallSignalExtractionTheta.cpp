 ...
 * -
 */
void fCrystalBallPDFFitJPsi(TH1F* histoToBeFit, Double_t* &bookKeeping)
{
 ...
 * -
 */
void fCrystalBallFitJPsi(TH1F* histoToBeFit, Double_t* &bookKeeping)
{
 ...
 * -
 */
void fCrystalBallFitPsiPrime(TH1F* histoToBeFit, Double_t* &bookKeeping)
{
  TF1* CBfit     = new TF1("CBfit","crystalball",2,15);
  CBfit       ->SetParameter(0,1);
  CBfit       ->SetParameter(3,1.08);
 ...
 * -
 */
void fBkgPolFit(TH1F* histoToBeFit, Double_t* &bookKeeping)
{
  ...
  bookKeeping = new Double_t[5];
  for(Int_t i = 0; i < 5; i++){
    bookKeeping[i] = PolBkg->GetParameter(i);
  }
}
//_____________________________________________________________________________
