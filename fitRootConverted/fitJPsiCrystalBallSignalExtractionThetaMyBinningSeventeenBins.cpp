...
void fitJPsiTemplate(const int selectionFlag){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyCosThetaForSignalExtractionHelicityFrameMySeventeenBinsVariableBinningH_%d", selectionFlag) );
  ...
  gPad->SaveAs(Form("pngResults/FunctionalSignalCosThetaMySeventeenBinning_%d.png", selectionFlag), "recreate");
...
void CreateCosThetaTh1(const char* AnalysisName){
  ...
  Double_t CosThetaBinCentersV2[9] = { -0.55, -0.375, -0.225, -0.1, 0, 0.1, 0.225, 0.375, 0.55 };
  ...
  Double_t MyVariableCosThetaBinning1Dv3[] = { -0.65,  -0.5,  -0.425, -0.35,
                                               ...
                                               -0.025,  0.025, 0.075,  0.125,
                                                ...
                                                0.5,    0.65 };
  Double_t MyVariableCosThetaBinningCenters1Dv3[17] = { -0.575,  -0.4625, -0.3875,
                                                        -0.3125, -0.2375, -0.1625,
                                                        -0.0875, -0.05,    0,
                                                         0.05,    0.0875,  0.1625,
                                                         0.2375,  0.3125,  0.3875,
                                                         0.4625,  0.575 };
  // for(Int_t iCosThetaBins = 0; iCosThetaBins < 17; iCosThetaBins++){
  //   MyVariableCosThetaBinningCenters1Dv3[iCosThetaBins] = ( MyVariableCosThetaBinning1Dv3[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv3[iCosThetaBins] ) / 2;
  //   cout << MyVariableCosThetaBinningCenters1Dv3[iCosThetaBins];
  // }
  ...
  // }
  for( Int_t looping = 0; looping < 9; looping++ ) {cout << "CosThetaBinCenters  "  << CosThetaBinCentersV2[looping] << endl; }
  ...
  for (size_t iCosThetaBins = 0; iCosThetaBins < 17; iCosThetaBins++) {
    // for (size_t iPhiBins = 0; iPhiBins < 10; iPhiBins++) {
      ...
      CosThetaAfterSignalExtractionH->Fill( // -0.975 + (Double_t)iCosThetaBins * 0.05,
                                            ...
                                            MyVariableCosThetaBinningCenters1Dv3[iCosThetaBins],
                                            JPsiPeakValue/( MyVariableCosThetaBinning1Dv3[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv3[iCosThetaBins] )
      ...
      //                            // -2.826 + (Double_t)iPhiBins      * 0.628,
      //                            // -3.14 + 0.314 * ( 2.0 * (Double_t)iPhiBins + 1.0) ,
      //                            ( MyVariableCosThetaBinning1Dv3[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv3[iCosThetaBins] )*0.5,
      ...
      CosThetaGammaGammaErrorsH->Fill(  // -0.975 + (Double_t)iCosThetaBins * 0.05,
                                        ...
                                        // -3.14 + 0.314 * ( 2.0 * (Double_t)iPhiBins + 1.0) ,
                                        MyVariableCosThetaBinningCenters1Dv3[iCosThetaBins],
                                        BkgValue/( MyVariableCosThetaBinning1Dv3[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv3[iCosThetaBins] )
                                        // BkgValue/Widths[iCosThetaBins]
                                        );
      CosThetaAfterSignalExtractionErrorsH->SetBinError(  iCosThetaBins + 1 ,
                                                          // iPhiBins      + 1 ,
                                                          JPsiPeakValueErr/( MyVariableCosThetaBinning1Dv3[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv3[iCosThetaBins] )
                                                          // JPsiPeakValueErr/Widths[iCosThetaBins]
                                                          );
      CosThetaGammaGammaErrorsH->SetBinError(  iCosThetaBins + 1 ,
                                               // iPhiBins      + 1 ,
                                               BkgValueError/( MyVariableCosThetaBinning1Dv3[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv3[iCosThetaBins] )
  ...
  TFile f("pngResults/TH1functionalCosThetaMySeventeenBinningEX.root", "recreate");
