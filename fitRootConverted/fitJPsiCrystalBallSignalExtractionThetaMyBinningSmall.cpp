...
void fitJPsiTemplate(const int selectionFlag){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyCosThetaForSignalExtractionHelicityFrameMyStrictVariableBinningH_%d", selectionFlag) );
...
void CreateCosThetaTh1(const char* AnalysisName){
  ...
  TH1F* CosThetaAfterSignalExtractionH =
            new TH1F( "CosThetaAfterSignalExtractionH",
                      ...
                      // 40, -1, 1//, 10, -3.14, 3.14
                      // 10, -1, 1, 10, -4, 4
                      9, MyVariableCosThetaBinning1Dv2
                      );
  ...
  for (size_t iCosThetaBins = 0; iCosThetaBins < 9; iCosThetaBins++) {
    // for (size_t iPhiBins = 0; iPhiBins < 10; iPhiBins++) {
      ...
      CosThetaAfterSignalExtractionH->Fill( // -0.975 + (Double_t)iCosThetaBins * 0.05,
                                            ...
                                            CosThetaBinCentersV2[iCosThetaBins],
                                            JPsiPeakValue/( MyVariableCosThetaBinning1Dv2[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv2[iCosThetaBins] )
      ...
      CosThetaGammaGammaErrorsH->Fill(  // -0.975 + (Double_t)iCosThetaBins * 0.05,
                                        ...
                                        // -3.14 + 0.314 * ( 2.0 * (Double_t)iPhiBins + 1.0) ,
                                        CosThetaBinCentersV2[iCosThetaBins],
                                        BkgValue/( MyVariableCosThetaBinning1Dv2[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv2[iCosThetaBins] )
                                        // BkgValue/Widths[iCosThetaBins]
                                        );
      CosThetaAfterSignalExtractionErrorsH->SetBinError(  iCosThetaBins + 1 ,
                                                          // iPhiBins      + 1 ,
                                                          JPsiPeakValueErr/( MyVariableCosThetaBinning1Dv2[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv2[iCosThetaBins] )
                                                          // JPsiPeakValueErr/Widths[iCosThetaBins]
                                                          );
      CosThetaGammaGammaErrorsH->SetBinError(  iCosThetaBins + 1 ,
                                               // iPhiBins      + 1 ,
                                               BkgValueError/( MyVariableCosThetaBinning1Dv2[iCosThetaBins+1] - MyVariableCosThetaBinning1Dv2[iCosThetaBins] )
  ...
  TFile f("pngResults/TH1functionalCosThetaMySmallBinningEX.root", "recreate");
