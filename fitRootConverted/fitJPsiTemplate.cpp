...
void fitJPsiTemplate(const char* AnalysisName, const int selectionFlag){
  ...
  if      ( selectionFlag == 0 ) gPad->SaveAs("pngResults/PtIntJPsi.png",      "RECREATE");
  else if ( selectionFlag == 1 ) gPad->SaveAs("pngResults/CoherentJPsi.png",   "RECREATE");
  else if ( selectionFlag == 2 ) gPad->SaveAs("pngResults/IncoherentJPsi.png", "RECREATE");
