                       ...
                       int iRapidityBin             )
{
   ...
   */
  TH1F *fAngularDistribOfPositiveMuonRestFrameJPsiH = (TH1F*)listingsData->FindObject( Form("fPhiHelicityFrameJPsiTenRapidityBinsH_%d", iRapidityBin) );
  ...
  TH1F *fMCAngularDistribOfPositiveMuonRestFrameJPsiH = (TH1F*)listingsMC->FindObject( Form("fPhiHelicityFrameJPsiTenRapidityBinsH_%d", iRapidityBin) );
  ...
  TH1F *fMCthetaDistribOfPositiveMuonRestFrameJPsiGeneratedTruthH = (TH1F*)listingsMC->FindObject( Form("fMCPhiHelicityFrameJPsiTenRapidityBinsH_%d", iRapidityBin) );
  ...
  */
  ...
  latex->DrawLatex(0.55,0.72,Form("#rho_{00} = %.2f #pm %.2f",
  ...
  gPad->SaveAs(Form("pngResults/PhiHe10Bins_%d.png", iRapidityBin), "RECREATE");

  new TCanvas;
  acceptance->Draw("ep");
  gPad->SaveAs(Form("pngResults/PhiHe10BinsACCxEFF_%d.png", iRapidityBin), "RECREATE");
