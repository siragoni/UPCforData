...
// opt = 1; 2018 r
{
    ...
    if(local) {
        ...
        alienHandler->SetExecutable("Polarisation.sh");
        // specify how many seconds your job may take
        alienHandler->SetTTL(10000);
        alienHandler->SetJDLName("Polarisation.jdl");
        ...
        if (opt == 0) alienHandler->SetGridWorkingDir("PbPb18q_pol_test");
        if (opt == 1) alienHandler->SetGridWorkingDir("PbPb18r_pol_test");
        if (opt == 2) alienHandler->SetGridWorkingDir("PbPb15o_pol_test");
